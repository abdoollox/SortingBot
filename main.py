...
async def sorting_hat_process(callback: types.CallbackQuery):
    ...
    stats_tugma = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="📊 Fakultetlar ro'yxatini ko'rish", callback_data="show_house_stats")]
    ])
...
async def show_stats(callback: types.CallbackQuery):
    ...
    text = (
        ...
        f"🦁 Gryffindor: **{counts['Gryffindor']}** ta talaba\n"
        f"🐍 Slytherin: **{counts['Slytherin']}** ta talaba\n"
        f"🦅 Ravenclaw: **{counts['Ravenclaw']}** ta talaba\n"
        f"🦡 Hufflepuff: **{counts['Hufflepuff']}** ta talaba\n\n"
